    ...
    return (
        <div className="bg-gray-500 p-4 rounded-lg">
            <div className="flex flex-col items-center gap-2 border-b-2 pb-3">
                <h1 className="font-bold text-xl text-white">Login user</h1>
                ...
                <button className="bg-blue-500 text-white p-2 rounded-md font-semibold cursor-pointer" onClick={loginUser}>Login</button> 
            </div>
            <div className="flex items-center gap-2 mt-2">
                <p className="text-sm text-white">Don't have an account?</p>
                <Link to="/register" className="underline text-blue-900"> Register </Link>
            </div>
        </div>
    )
}